...
const About = () => {
  return (
    <section className="about">
      <div className="max-w-6xl m-auto px-5 py-10">
        ...
        <div className="flex flex-col items-center mt-12 gap-5 text-[#2A2B30]">
          ...
          <p className="text-[18px] text-center">
            <span className="font-semibold">In September 2018,</span> in Palu, Central Sulawesi faced
            disasters <span className="font-semibold">(tsunami, earthquake, soil liquefaction)</span>.
