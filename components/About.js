    ...
    <section className="about">
      <div className="max-w-6xl m-auto px-5 md:pt-10 pt-5">
        ...
        <div
          data-aos="fade-up"
          data-aos-duration="800"
          className="flex flex-col items-center md:mt-12 mt-7 gap-5 text-[#2A2B30]"
        >
          <h3 className="font-semibold md:text-[22px] text-[20px]">
            Why We Are Exist?
          </h3>
          <p className="md:text-[18px] text-[13px] text-center">
            At <span className="font-semibold">Impact Palu</span>, we believe
            that social enterprises will develop a sustainable solution for
            social and environmental problems in Palu and beyond. By supporting
            aspiring social entrepreneurs with capacity building programs and
            connecting them with pertinent stakeholders to achieve a greater
            impact.
          </p>
        </div>
        <div data-aos="fade-down" data-aos-duration="800" className="md:mx-10">
